...
namespace HoloToolkit.Unity.UX
{
    ...
    public class BoundingBox : MonoBehaviour
    {
        public enum BoundsCalculationMethodEnum
        {
            ...
            Collider,           //仅获取当前GameObject的Collider
        }
        ...
        protected virtual void RefreshTargetBounds()
        {
            ...
            switch (boundsCalculationMethod)
            {
                ...
                case BoundsCalculationMethodEnum.Collider:
                    GetSelfColliderBoundsPoints(target, boundsPoints, ignoreLayers);
                    break;
            }
        ...
        public static void GetSelfColliderBoundsPoints(GameObject target, List<Vector3> boundsPoints, LayerMask ignoreLayers) {
